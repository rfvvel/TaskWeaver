    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center">
        <motion.div
          ...
          transition={{ duration: 1 }}
          className="drop-shadow-[0_0_35px_rgba(59,130,246,0.9)]"
        >
        ...
        <motion.p
          ...
          className="mt-6 text-sm md:text-base tracking-[0.4em] text-blue-200"
        >
        ...
        <motion.div
          ...
          className="mt-8 h-[3px] rounded-full bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500"
        />
        ...
        <motion.p
          ...
          className="mt-4 text-xs tracking-[0.5em] text-blue-400"
        >
          LOADING...
        </motion.p>
      </div>
